...
for i = 1:num_x
    ...
    precision = precision + precision_num/precision_den;
    recall = recall +recall_num/recall_den;
end

precision = precision/double(num_x);
recall = recall/double(num_x);

F1score = 2*precision*recall/(precision+recall);

result = [ACC MIhat F1score];
